...
dat = fetch.get_telem(['2PRBSCR', '2S2HVST', '2SHEV1RT'], '2020:220')

ax1.plot_date(hrc.convert_chandra_time(
    dat['2SHEV1RT'].times), dat['2SHEV1RT'].vals, color=purple, linewidth=2.0)

ax2 = ax1.twinx()
ax2.plot_date(hrc.convert_chandra_time(
    dat['2PRBSCR'].times), dat['2PRBSCR'].vals,  color=blue, linewidth=2.0)
