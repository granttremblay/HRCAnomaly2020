...
fetch.data_source.set('maude allow_subset=True') # allow_subset=True should let us draw more data points
...
parser = argparse.ArgumentParser (description = 
                                  'Compare good and bad MSID distributions.')
...
if not tend:
    ...
    tend = dt.datetime.utcnow ().strftime ("%Y:%j:18:00:00")
